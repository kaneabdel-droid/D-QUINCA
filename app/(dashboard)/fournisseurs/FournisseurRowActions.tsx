  ...
  return (
    <>
      <div className="flex justify-end gap-2">
        <ReleveButton releveType="fournisseur" magasinId={magasinId} entreprise={entreprise} devise={devise} referenceId={fournisseur.id} referenceNom={fournisseur.nom} dict={dict} />
